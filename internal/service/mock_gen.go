...
func (m *MockAuth) Authentication(user core.Client) (core.Tokens, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Authentication", user)
	ret0, _ := ret[0].(core.Tokens)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAuth) ParseToken(accessToken string) (*ParseDataUser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseToken", accessToken)
	ret0, _ := ret[0].(*ParseDataUser)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockCassettes) CreateCassette(newCassette core.CreateCassetteReq) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCassette", newCassette)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCassettesMockRecorder) CreateCassette(newCassette interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCassette", reflect.TypeOf((*MockCassettes)(nil).CreateCassette), newCassette)
}
